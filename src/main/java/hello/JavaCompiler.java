...
public class JavaCompiler implements JavaCompilerInterface {
    ...
    public String generateCompilerOutput(String code, String className) throws Exception {
        ...
        Class<?> classNameObject = classLoader.loadClass(className);
        Method main = classNameObject.getMethod("main", String[].class);
